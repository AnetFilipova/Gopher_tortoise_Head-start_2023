...
Plate1_MPX <- read.csv("Telo_mtDNA/Manuscript_Analysis/Data/GT_Plate1_Multiplex_12_11_2024_Quantification_Cq_Results.csv")
dim (Plate1_MPX)

Plate1_Telo <- read.csv("Telo_mtDNA/Manuscript_Analysis/Data/GT_Plate1_Telomeres_12_11_2024_Quantification_Cq_Results.csv")
dim (Plate1_Telo)
...
write.csv(file = "Telo_mtDNA/Manuscript_Analysis/Data/Plate1_FinalData.csv", Plate1_FinalData, row.names = FALSE)
...
# Import .csv files for each run for a particular plate of samples 
Plate2_MPX <- read.csv("Telo_mtDNA/Manuscript_Analysis/Data/GT_Plate2_Multiplex_12_12_2024_Quantification_Cq_Results.csv")
dim (Plate2_MPX)

Plate2_Telo <- read.csv("Telo_mtDNA/Manuscript_Analysis/Data/GT_Plate2_Telomeres_12_12_2024_Quantification_Cq_Results.csv")
dim (Plate2_Telo)
...
# Write the final data file for this plate
write.csv(file = "Telo_mtDNA/Manuscript_Analysis/Data/Plate2_FinalData.csv", Plate2_FinalData, row.names = FALSE)
...
# Import .csv files for each run for a particular plate of samples 
Plate3_MPX <- read.csv("Telo_mtDNA/Manuscript_Analysis/Data/GT_Plate3_Multiplex_12_16_2024_Quantification_Cq_Results.csv")
dim (Plate3_MPX)

Plate3_Telo <- read.csv("Telo_mtDNA/Manuscript_Analysis/Data/GT_Plate3_Telomeres_12_16_2024_Quantification_Cq_Results.csv")
dim (Plate3_Telo)
...
# Write the final data file for this plate
write.csv(file = "Telo_mtDNA/Manuscript_Analysis/Data/Plate3_FinalData.csv", Plate3_FinalData, row.names = FALSE)
...
# Import .csv files for each run for a particular plate of samples 
Plate4_MPX <- read.csv("Telo_mtDNA/Manuscript_Analysis/Data/GT_Plate4_Multiplex_12_17_2024_Quantification_Cq_Results.csv")
dim (Plate4_MPX)

Plate4_Telo <- read.csv("Telo_mtDNA/Manuscript_Analysis/Data/GT_Plate4_Telomeres_12_17_2024_Quantification_Cq_Results.csv")
dim (Plate4_Telo)
...
# Write the final data file for this plate
write.csv(file = "Telo_mtDNA/Manuscript_Analysis/Data/Plate4_FinalData.csv", Plate4_FinalData, row.names = FALSE)
...
# Import .csv files for each run for a particular plate of samples 
Plate5_MPX <- read.csv("Telo_mtDNA/Manuscript_Analysis/Data/GT_Plate5_Multiplex_12_17_2024_Quantification_Cq_Results.csv")
dim (Plate5_MPX)

Plate5_Telo <- read.csv("Telo_mtDNA/Manuscript_Analysis/Data/GT_Plate5_Telomeres_12_17_2024_Quantification_Cq_Results.csv")
dim (Plate5_Telo)
...
# Write the final data file for this plate
write.csv(file = "Telo_mtDNA/Manuscript_Analysis/Data/Plate5_FinalData.csv", Plate5_FinalData, row.names = FALSE)
...
# Import .csv files for each run for a particular plate of samples 
Plate6_MPX <- read.csv("Telo_mtDNA/Manuscript_Analysis/Data/GT_Plate6_Multiplex_12_18_2024_Quantification_Cq_Results.csv")
dim (Plate6_MPX)

Plate6_MPX <- Plate6_MPX[, -c(1)]

Plate6_Telo <- read.csv("Telo_mtDNA/Manuscript_Analysis/Data/GT_Plate6_Telomeres_12_18_2024_Quantification_Cq_Results.csv")
dim (Plate6_Telo)
...
# Write the final data file for this plate
write.csv(file = "Telo_mtDNA/Manuscript_Analysis/Data/Plate6_FinalData.csv", Plate6_FinalData, row.names = FALSE)

# Merge all FinalData together, for each plate, by concatenating the rows

# Load each plate's final data
Plate1_FinalData <- read.csv("Telo_mtDNA/Manuscript_Analysis/Data/Plate1_FinalData.csv")
Plate2_FinalData <- read.csv("Telo_mtDNA/Manuscript_Analysis/Data/Plate2_FinalData.csv")
Plate3_FinalData <- read.csv("Telo_mtDNA/Manuscript_Analysis/Data/Plate3_FinalData.csv")
Plate4_FinalData <- read.csv("Telo_mtDNA/Manuscript_Analysis/Data/Plate4_FinalData.csv")
Plate5_FinalData <- read.csv("Telo_mtDNA/Manuscript_Analysis/Data/Plate5_FinalData.csv")
Plate6_FinalData <- read.csv("Telo_mtDNA/Manuscript_Analysis/Data/Plate6_FinalData.csv")
...
# Import .csv files for each run for a particular plate of samples 
Trait <- read.csv("Telo_mtDNA/Manuscript_Analysis/Data/Trait_MetaData.csv")
dim (Trait)
dim(qPCR_FinalData)
...
write.csv(FinalData, "Telo_mtDNA/Manuscript_Analysis/Data/GT_FinalData.csv", row.names = FALSE)
...
# Load the data
data <- read_csv("Telo_mtDNA/Manuscript_Analysis/Data/GT_FinalData.csv")
...
write_csv(percent_change_wide, "Telo_mtDNA/Manuscript_Analysis/Data/GT_PercentChange.csv")
...
growth_data <- read_csv("Telo_mtDNA/Manuscript_Analysis/Data/GT_GrowthData.csv") %>%
...
percent_change_wide <- read_csv("Telo_mtDNA/Manuscript_Analysis/Data/GT_PercentChange.csv") %>%
  mutate(
...
write_csv(merged_data, "Telo_mtDNA/Manuscript_Analysis/Data/GT_Growth_Telo_mtDNA.csv")
...
merged_data <- read.csv("Telo_mtDNA/Manuscript_Analysis/Data/GT_Growth_Telo_mtDNA.csv", na.strings = "NA")
str(merged_data)
...
ggsave(mtDNA_plot, file = "Telo_mtDNA/Manuscript_Analysis/Figures/mtDNA_density.png", width = 12, height = 6, dpi = 600)
...
# Save the plot as PNG for final figure production
ggsave(telomeres_plot, file = "Telo_mtDNA/Manuscript_Analysis/Figures/Telomere_length.png", width = 12, height = 6, dpi = 600)
